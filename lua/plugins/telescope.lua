return {
	...
	config = function()
		...
		vim.keymap.set('n', '<leader>fz', ":Telescope find_files hidden=true no_ignore=true<CR>", { desc = 'Telescope find files' })
		...
		vim.keymap.set('n', '<leader>fc', builtin.keymaps, { desc = 'Telescope Lists available plugin/user commands and runs them on <cr>' })
